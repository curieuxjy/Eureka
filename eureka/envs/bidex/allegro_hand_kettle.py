...
class AllegroHandKettle(VecTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        max_agg_bodies = self.num_allegro_hand_bodies * 2 + 2 * self.num_object_bodies + self.num_bucket_bodies + 4*4*4
        max_agg_shapes = self.num_allegro_hand_shapes * 2 + 2 * self.num_object_shapes + self.num_bucket_shapes + 4*4*4
        ...
        for i in range(self.num_envs):
            ...
            allegro_hand_another_actor = self.gym.create_actor(env_ptr, allegro_hand_another_asset, shadow_another_hand_start_pose, "another_hand", i, -1, 0)

...
class AllegroHandScissors(VecTask):
    ...
    def reset_idx(self, env_ids, goal_env_ids):
        ...
        self.prev_targets[env_ids, self.num_allegro_hand_dofs*2:self.num_allegro_hand_dofs*2 + 2] = to_torch([-0.59], device=self.device)
        self.cur_targets[env_ids, self.num_allegro_hand_dofs*2:self.num_allegro_hand_dofs*2 + 2] = to_torch([-0.59], device=self.device)

...
class AllegroHandReOrientation(VecTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        max_agg_bodies = self.num_allegro_hand_bodies * 2 + 2 * 2
        max_agg_shapes = self.num_allegro_hand_shapes * 2 + 2 * 2
    ...
    def pre_physics_step(self, actions):
        ...
        if self.use_relative_control:
            ...
            self.cur_targets[:, self.actuated_dof_indices + 16] = scale(self.actions[:, 20:40],
                                                                   self.allegro_hand_dof_lower_limits[self.actuated_dof_indices], self.allegro_hand_dof_upper_limits[self.actuated_dof_indices])
